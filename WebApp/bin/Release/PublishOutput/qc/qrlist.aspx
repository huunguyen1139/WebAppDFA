   ...
   <script type="text/javascript">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <div class="main-page">
				<h2 class="title1">BBCL <asp:Button runat="server" ID="btnCancel" style="float:right;padding: 5px 12px;" class="btn btn-success" OnClientClick="window.open('defect.aspx', '_blank');" Text="THÊM MỚI"></asp:Button></h2>
                            ...
                            <div runat="server" class="form-body collapse" data-example-id="simple-form-inline" id="header">
                                ...
                                <div class="row">
                                    ...
                                    <%--<div class="col-md-4 grid_box1">
                                        <div class="form-group">
                                            <label>Team gây lỗi <em>(*)</em></label>
                                            <asp:DropDownList runat="server" ID="DropDownList2" CssClass="form-control" OnSelectedIndexChanged="ddDefectOfTeam_SelectedIndexChanged" AutoPostBack="true">
                                                <asp:ListItem Value="0" Text="-Chọn-"></asp:ListItem>
