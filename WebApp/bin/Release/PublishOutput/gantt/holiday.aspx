<%@ Page Title="Holiday" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="holiday.aspx.cs" Inherits="WebApplication2.gantt.holiday" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow-x:auto">
                    ...
                    <div class="col-md-12 m-b-20 form-group">
                       <asp:TextBox runat="server" TextMode="Date" CssClass="form-control" ID="txtNewHoliday"></asp:TextBox> 
                                                        </div>
                    <div class="col-md-12 m-b-20">
                       <asp:TextBox runat="server" CssClass="form-control" ID="txtDescription" placeholder="Holiday's description..."></asp:TextBox> 
                                                        </div>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="holiday.aspx">Holiday</a></li>
            ...
            <button type="button" style="margin-bottom: 10px; float: right" class="btn btn-info" data-toggle="modal" onclick="ShowHolidayRegisterForm()">Add New Holiday</button>
            <h3>Holidays</h3>
