<%@ Page Title="Factory Order List" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="factory_order.aspx.cs" Inherits="WebApplication2.factory_order" %>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="border-bottom title-part-padding bg-body">
                            <h4 id="txtDesciptionHeader" runat="server" class="card-title mb-0 text-dark">Factory Order List</h4>
                        </div>
                        <div class="card-body shadow-sm table-responsive1 ">
                            <div class="row mx-0 mb-2">
                                <div class="col-md-12 px-0">
                                    ...
                                    <asp:CheckBox runat="server" CssClass="form-check form-check-inline" ID="cbShowAllRecord" Checked="false" Text="Show All Records" OnCheckedChanged="cbLastUpdateInfo_CheckedChanged" AutoPostBack="True" />
                                </div>
                            </div>
                            <dx:ASPxGridView ID="gridFactoryOrder" EnablePagingGestures="False" CssClass="" runat="server" Width="100%" 
                                AutoGenerateColumns="True" OnHtmlDataCellPrepared="gridFactoryOrder_HtmlDataCellPrepared" >
                                ...
                                <SettingsBehavior AllowFocusedRow="false" AllowGroup =" true" />
                                <Settings ShowFooter="true" ShowHeaderFilterButton="true" ShowGroupPanel ="true" HorizontalScrollBarMode="Auto"/>
                                <GroupSummary>
                                    <dx:ASPxSummaryItem FieldName="OrderNo" SummaryType="Count"  DisplayFormat="Total records: {0:n0}" />
                                    <dx:ASPxSummaryItem FieldName="TotalAmount" SummaryType="Sum"  DisplayFormat="Sum: {0:n0}" />
                                </GroupSummary>
