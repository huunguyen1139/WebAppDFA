<%@ Page Title="Factory Order List" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="factory_order_completed.aspx.cs" Inherits="WebApplication2.factory_order_completed" %>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="border-bottom title-part-padding bg-body">
                            <h4 id="txtDesciptionHeader" runat="server" class="card-title mb-0 text-dark">Competed Factory Order List</h4>
                        </div>
                        <div class="card-body shadow-sm table-responsive ">
                            ...
                            <dx:ASPxGridView ID="gridFactoryOrder" EnablePagingGestures="False" CssClass="" runat="server" Width="100%" AutoGenerateColumns="True" OnHtmlDataCellPrepared="gridFactoryOrder_HtmlDataCellPrepared">
