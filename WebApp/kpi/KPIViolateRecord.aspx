                                        ...
                                        <div id="col1" class="collapse show" aria-labelledby="heading1"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:GridView runat="server" ID="gvViolationRecord" border="1" CssClass="table no-wrap table-striped table-bordered" EmptyDataText="No records found" AutoGenerateColumns="false">
