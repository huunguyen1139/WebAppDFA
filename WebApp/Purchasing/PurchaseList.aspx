<%@ Page Title="Purchase Order List" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="PurchaseList.aspx.cs" Inherits="WebApp.Purchase.PurchaseList" %>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="border-bottom title-part-padding bg-body">
                            <h4 id="txtDesciptionHeader" runat="server" class="card-title mb-0 text-dark">Purchase Order</h4>
                        </div>
                        <div class="card-body shadow-sm table-responsive ">
                            ...
                            <dx:ASPxGridView ID="gridTenderOrder" CssClass="" EnablePagingGestures="False" runat="server" Width="100%" AutoGenerateColumns="True" OnHtmlDataCellPrepared="gridTenderOrder_HtmlDataCellPrepared">
                                ...
                                <TotalSummary>
                                    <dx:ASPxSummaryItem FieldName="TenderOrderNo" SummaryType="Count" />
                                    <dx:ASPxSummaryItem FieldName="ProjectAmount" SummaryType="Sum" />
                                    <dx:ASPxSummaryItem FieldName="Sitemount" SummaryType="Sum" />
                                </TotalSummary> 
                            </dx:ASPxGridView>
