<%@ Page Title="Production SUB Output History" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="ProductionSubValue.aspx.cs" Inherits="WebApp.production.ProductionSubValue" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="border-bottom rounded-top title-part-padding bg-body">
                            <h3 class="card-title mb-0 text-dark">Production SUB Output History</h3>
                        </div>
                        <div class="card-body pt-3 table-responsive">
                            ...
                            <dx:ASPxGridView ID="gridProductionOutput" EnablePagingGestures="False" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="ProdOrderNo" Caption="Prod Order No" Width="130px" />
                                    <dx:GridViewDataTextColumn FieldName="Department" Caption="Dept." Width="60px" />  
                                     <dx:GridViewDataTextColumn FieldName="SubGroup" Caption="Sub Dept." Width="100px" /> 
