...
{
    public partial class ProductionOutputHistory : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            cbUpdatedDate.InputAttributes["class"] = "form-check-input";
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Library.LibraryFunction.InsertActivitiesLog(Session["userid"].ToString(), "Xem production OUTPUT HISTORY");
            }
            LoadGridData();
        }
        ...
        private void LoadGridData()
        {
            ...
            {               
                ...
                string toDepartment = ddToDepartment.SelectedValue;

                department = department == null ? "" : department;
                toDepartment = toDepartment == null ? "" : toDepartment;

                DataTable dt = SQRLibrary.ReturnDatatablefromSQL(
                "EXEC [ALL_OUTPUT_GetProductionOutputDetailWithRevenue] @FromDate, @ToDate, @Department, @ToDepartment",
                new List<string> { "@FromDate", "@ToDate", "@Department", "@ToDepartment" },
                new List<object> { fromDate.Text, toDate.Text, department, toDepartment }
                );
                ...
                gridProductionOutput.Columns["UpdatedDate"].Visible = cbUpdatedDate.Checked;
            }
            catch (Exception ex)
            {                
        ...
        {
            if (e.Visible >= 0 && e.ButtonID == "btnDelete")
            {                
