<%@ Page Title="Defect Logs" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="qrlist.aspx.cs" Inherits="WebApplication2.qrlist" %>
        ...
        <ContentTemplate>
            <div class="body-wrapper" style="display: block; min-height: calc(100vh - 53px);">
                <div class="container-fluid">
                    <h2 class="title1">
                        <asp:Label runat="server" ID="lbBBCL" Text="BBCL"></asp:Label>
