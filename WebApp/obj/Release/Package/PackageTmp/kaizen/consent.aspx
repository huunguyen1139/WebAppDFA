<%@ Page Title="Kaizen Register Application" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="consent.aspx.cs" Inherits="WebApplication2.consent" %>
                ...
                <div class="container-fluid">
                                ...
                                <div class="d-flex align-items-center">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">My Kaizen
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div runat="server" class="card-body" id="header">
                            ...
                            <div class="row mb-3" runat="server" id="divBP_NV" visible="false" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2 grid_box1">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddPaid" CssClass="form-control" Enabled="true" AutoPostBack="true" disabled>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddStatus" CssClass="form-control" Enabled="true" AutoPostBack="true" disabled>
                                            <asp:ListItem Value="0" Text="-Tất cả-"></asp:ListItem>
