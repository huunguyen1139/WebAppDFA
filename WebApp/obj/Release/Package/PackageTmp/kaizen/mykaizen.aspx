<%@ Page Title="Kaizen Register Application" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="mykaizen.aspx.cs" Inherits="WebApplication2.mykaizen" %>
                            ...
                            <div class="card w-100">
                                <div class="card-body p-0">
                                    <div class="border-bottom title-part-padding bg-secondary text-white">
                                        <h4 class="card-title mb-0 text-white">Leaderboard (Personal)
                                        </h4>
                                    </div>
