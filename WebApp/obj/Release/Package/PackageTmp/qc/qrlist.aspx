<%@ Page Title="Defect Logs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="qrlist.aspx.cs" Inherits="WebApplication2.qrlist" %>
   ...
   <script type="text/javascript">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <div class="main-page">
				<h2 class="title1"><asp:Label runat="server" ID="lbBBCL" Text="BBCL"></asp:Label> <asp:Button runat="server" ID="btnCancel" style="float:right;padding: 5px 12px;" class="btn btn-success" OnClientClick="window.open('defect.aspx', '_blank');" Text="THÊM MỚI"></asp:Button></h2>
			
				<div class="col-md-12" style="padding: 0px">
                    <div class="panel-default">
                        <div class="form-two widget-shadow" style="box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.5);">
                            <div class="form-title" style="background-color: whitesmoke;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 grid_box1">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtProductDes" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtProductDes_TextChanged"></asp:TextBox>
                        ...
                        <div class="widget-shadow" style="margin: 20px 0px;box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.5);">
                            ...
                            <div class="table-scroll">
                                <asp:GridView runat="server" ID="gvDetailDefect" Width="100%" Visible="true" border="0"  CssClass="tablerowsmall table-hover table-striped" EmptyDataText="No records found" AutoGenerateColumns="False" style="white-space: nowrap;">
