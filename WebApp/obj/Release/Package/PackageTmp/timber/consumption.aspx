                    ...
                    <div class="card">
                        ...
                        <div class="card-body wizard-content">
                            <div class="tab-wizard wizard-circle wizard clearfix">
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView runat="server" ID="gvConsumption" border="0" CssClass="tablesm form-material" style="font-size: 13px;" EmptyDataText="No records found" AutoGenerateColumns="false">
                                                ...
                                                <Columns>                                                    
                                                    ...
                                                    <asp:BoundField DataField="Quantity" HeaderText="ProdQty" />     
                                                    <asp:BoundField DataField="PINo" HeaderText="PI" />                                                   
                                                    ...
                                                    <asp:TemplateField HeaderText="Bundle">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:DropDownList runat="server" ID="ddBundleCode" CssClass="select2" style="width: 140px">
                                                    ...
                                                    <asp:TemplateField HeaderText="PCS">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtPCS" CssClass="form-control" Text='0' style="width: 40px;"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="M3">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtM3" Text='0' style="width: 60px;"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Re-M3">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtReturnM3" Text="0" style="width: 60px;"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                ...
                                <div id="step2plus" runat="server" class="border-bottom"> 
                                    <div class="row mb-5">
                                        <span>Posted Consumption</span>
                                        <div class="table-responsive">
                                            <asp:GridView runat="server" ID="gvPostedConsumption" border="0" CssClass="tablesm" EmptyDataText="No records found" AutoGenerateColumns="false">
                                                <HeaderStyle CssClass="table-light" />
                                                <RowStyle VerticalAlign="Middle" />
                                                <Columns>                                                    
                                                    <asp:BoundField DataField="PINo" HeaderText="PI" />
                                                    ...
                                                    <asp:BoundField DataField="ProductName" HeaderText="Product Name" />
                                                     <asp:BoundField DataField="ProdQty" HeaderText="Prod. Qtyr" /> 
                                                    <asp:BoundField DataField="BundleCode" HeaderText="Bundle No." />
                                                    <asp:BoundField DataField="PCS" HeaderText="PCS" />
                                                    <asp:BoundField DataField="M3" HeaderText="M3" />
                                                    <asp:BoundField DataField="ReturnM3" HeaderText="Return M3" /> 
                                                   <asp:BoundField DataField="ConsumpOn" HeaderText="Consumption Date" />
                                                    <asp:TemplateField HeaderText="">
                                                        <ItemTemplate>                                                            
                                                            <asp:LinkButton style="color: #E34724;" runat="server" ID="lbtnDeleteComponents" OnClick="lbtnDelete_Click"><i class="material-icons">&#xE872;</i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
