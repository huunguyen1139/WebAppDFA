<%@ Page Title="HR Headcount report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HRHeadcountReport.aspx.cs" Inherits="WebApplication2.HRHeadcountReport" %>
                    ...
                    <div class="row">
                                    <div class="col-md-4 grid_box1">
                                        <div class="form-group">
                                            <label>Từ ngày</label>
                                            <asp:TextBox runat="server" ID="txtFromDate" AutoPostBack="true"  TextMode="Date" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4 grid_box1">
                                        <div class="form-group">
                                            <label>Đến ngày</label>
                                            <asp:TextBox runat="server" ID="txtToDate" AutoPostBack="true" TextMode="Date" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                           <asp:Button runat="server" ID="btnLoad" Text="Load" CssClass="btn btn-success" style="margin-top: 20px;" OnClick="btnLoad_Click1"/>
                                        </div>
                                    </div>
