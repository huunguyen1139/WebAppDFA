<%@ Page Title="FGs Stock" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fgstockdetail.aspx.cs" Inherits="WebApplication2.fgstockdetail" %>
            ...
            <div class="">
                <div class="work-progres" style="box-shadow: 0px 0px 5px -2px rgba(0,0,0,0.75);background-color: white;padding: 10px;">
                    ...
                    <div class="table-master">
                        ...
                        <asp:Table runat="server" ID="tbDetailPI" CssClass="tablerowsmall table-hover table-striped"></asp:Table>
                    </div>
                </div>
