<%@ Page Title="Container Loading List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoadingHeader.aspx.cs" Inherits="WebApplication2.LoadingHeader" %>
        ...
        <ContentTemplate>
            ...
            <div class="">
                ...
                <div class="form-two widget-shadow" style="box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.5);">
                            ...
                            <div runat="server" class="form-body" data-example-id="simple-form-inline" id="header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddStatus" CssClass="form-control" OnSelectedIndexChanged="ddStatus_SelectedIndexChanged" AutoPostBack="true">
                                                <asp:ListItem Value="0" Text="All"></asp:ListItem>   
                                                <asp:ListItem Value="1" Text="Released"></asp:ListItem>   
                                                <asp:ListItem Value="2" Text="Loading"></asp:ListItem>   
