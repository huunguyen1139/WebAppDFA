<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kbtd.aspx.cs" Inherits="WebApplication2.kbyt.kbtd" %>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4  col-xs-12 ">
                <div class="btn-submit-box text-center" style="margin-top: 20px;">
                    <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-success" OnClick="btnLogin_Click" Text="Đăng nhập"/>
                </div>
            </div>
...
<div id="tab-9-2" class="tab-pane fade active in" style="background: white">
 <div id="module13" class="ModuleWrapper"><div class="artile-edit-layout ">

<div class="box box-edit-layout"> <div class="box-body no-padding">
 <br>  

<div class="form-resign2">
<div class="">
<div class="national-brand text-center mb-15">
<div class="text-uppercase"><b>Thông tin khai báo y tế</b></div>
...
<div class="row">
    <div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group label-width "> <label>Mã nhân viên <em style="line-height: 1">(*)</em></label>
...
<div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group label-width"> <label>Họ tên (ghi chữ IN HOA) <em style="line-height: 1">(*)</em></label>
...
<div class="row ">
<div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group inline-block form-inline label-width "> <label>Năm sinh  <em style="line-height: 1">(*)</em></label>
...
<div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group  "> <label>Giới tính  <em style="line-height: 1">(*)</em></label>
...
<td><asp:RadioButton runat="server" ID="radioNam" Checked="true" Text="Nam" GroupName="gioitinh" /></td><td>&nbsp;</td>
 
<td><asp:RadioButton runat="server" ID="radioNu"  Text="Nữ" GroupName="gioitinh"/></td><td>&nbsp;</td>
 
<td><asp:RadioButton runat="server" ID="radioKhac" Text="Khác" GroupName="gioitinh"/></td><td>&nbsp;</td>
...
<div class="mb-20"><b>Chỗ ở hiện tại</b></div>
<div class="row ">
<div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group label-width"> <label>Tỉnh thành  <em style="line-height: 1">(*)</em></label>
...
<div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group  label-width"> <label>Quận / huyện  <em style="line-height: 1">(*)</em></label> 
...
<div class="col-md-4 col-sm-4  col-xs-12 ">
<div class="form-group  label-width"> <label>Phường / xã  <em style="line-height: 1">(*)</em></label>
...
<div class="row ">
<div class="   col-xs-12 ">
<div class="form-group "> <label>Số nhà, phố, tổ dân phố/thôn/đội <em style="line-height: 1">(*)</em></label>
...
<div class="form-group label-width "> <label>Điện thoại  <em style="line-height: 1">(*)</em></label>
 <asp:TextBox runat="server" ID="txtDienThoai" type="number" CssClass="form-control" Text=""></asp:TextBox>

</div> 
</div> 
<div class="col-md-6 col-sm-6  col-xs-12 ">
<div class="form-group label-width "> <label>Email </label>
 <asp:TextBox runat="server" ID="txtEmail" CssClass="form-control" Text=""></asp:TextBox>
</div> 
</div> 
</div> 
<div class="form-group form-lenght ">
<label style="width:auto;font-weight:bold;">Trong vòng 14 ngày qua, Anh/Chị có đến tỉnh/thành phố, quốc gia/vùng lãnh thổ nào (Có thể đi qua nhiều nơi)</label>
<div class="mt-10 inline-block pl-10">
<asp:RadioButton runat="server" ID="radioDiaDiemDiQua_Khong" Checked="true" Text="Không" AutoPostBack="true" OnCheckedChanged="radioDiaDiemDiQua_Khong_CheckedChanged" GroupName="DiaDiemDiQua" />
<asp:RadioButton runat="server" ID="radioDiaDiemDiQua_Co" Text="Có" AutoPostBack="true" OnCheckedChanged="radioDiaDiemDiQua_Co_CheckedChanged" GroupName="DiaDiemDiQua" />
</div>
<div class="mt-10 showCountryPassing" runat="server" id="divDiaDiemDiQua">
        ...
        <div class="row " style="padding-top: 16px;">
            <div class="col-md-4 col-sm-4  col-xs-12 ">
                <div class="form-group label-width">
                    ...
                    <asp:DropDownList runat="server" ID="ddPhuongTienDiLai" CssClass="form-control" AutoPostBack="true">
                        <asp:ListItem Text="Chọn" Value="0"></asp:ListItem>
                        <asp:ListItem Text="Máy bay" Value="1"></asp:ListItem>
                        <asp:ListItem Text="Tàu hỏa" Value="2"></asp:ListItem>
                        <asp:ListItem Text="Xe khách" Value="3"></asp:ListItem>
                        <asp:ListItem Text="Tàu thuyền" Value="4"></asp:ListItem>
                        <asp:ListItem Text="Cá nhân" Value="5"></asp:ListItem>
                    </asp:DropDownList>
            ...
            <div class="col-md-4 col-sm-4  col-xs-12 ">
                <div class="form-group  label-width">
                    <label>Số hiệu phương tiện  <em style="line-height: 1">(*)</em></label>
...
<div class="form-group form-lenght ">
<label style="width:auto;font-weight:bold;">Trong vòng 14 ngày qua, Anh/Chị có thấy xuất hiện ít nhất 1 trong các dấu hiệu: sốt, ho, khó thở, viêm phổi, đau họng, mệt mỏi không?</label>
<div class="mt-10 inline-block pl-10">
<asp:RadioButton runat="server" ID="radioTrieuChungKhong" Checked="true" Text="Không" AutoPostBack="true" OnCheckedChanged="radioTrieuChungKhong_CheckedChanged" GroupName="TrieuChung" />
<asp:RadioButton runat="server" ID="radioTrieuChungCo" AutoPostBack="true" OnCheckedChanged="radioTrieuChungCo_CheckedChanged" Text="Có" GroupName="TrieuChung" />
</div>
...
<div class="mb-10"><b>Trong vòng 14 ngày qua, Anh/Chị có tiếp xúc với <span class="text-required">(*)</span></b></div>
<div class="row ">
<div class="   col-xs-12 ">
...
<tbody>
<tr>
<td>Người bệnh hoặc nghi ngờ, mắc bệnh COVID-19 <span class="text-required">(*)</span><br><label class="error" for="fields[hasPatient]"></label></td>
...
<tr>
<td>Người từ nước có bệnh COVID-19 <span class="text-required">(*)</span><br><label class="error" for="fields[hasFromSickCountry]"></label></td>
<td class="text-center">
...
<tr>
<td>Người có biểu hiện (Sốt, ho, khó thở , Viêm phổi) <span class="text-required">(*)</span><br><label class="error" for="fields[hasSick]"></label></td>
<td class="text-center">
...
<div class="agreeWrapper 456">  <div class="label-agree">Dữ liệu bạn cung cấp hoàn toàn bảo mật và chỉ phục vụ cho việc phòng chống dịch, thuộc quản lý SquareRoots</div> </div><style> .agreeWrapper .label-agree{ color:#f00; margin-bottom: 20px; word-break: break-word; line-height: 22px; }
</style> 
...
.form-resign2 .tableChoiceData .cols-right .table > tbody>tr>td:nth-child(1)
...
@media screen and (max-width: 480px){
.formWrapper .tableChoiceData .cols-right .table > tbody>tr>td:nth-child(1)
.formWrapper .tableChoiceData .table > tbody>tr>td:nth-child(1){
}
