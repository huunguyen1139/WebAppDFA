<%@ Page Title="Blanket Order Detail" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="ex_order_detail.aspx.cs" Inherits="WebApp.sampling.ex_order_detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function toggleReplyForm(el) {
            const replyForm = el.closest('.comment').querySelector('.reply-form');
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="button-group">
                                ...
                                <button type="button" runat="server" id="btnViewRelatedProductionOrder" class="btn btn-primary" onserverclick="btnViewRelatedProductionOrder_ServerClick" style="border-radius: 5px; float: right;">
                                    <i class="ti ti-direction-sign fs-4 me-2"></i>View Related Production Order
                                </button>
                            ...
                            <dx:ASPxGridView ID="gridFactoryOrderDetail" ClientInstanceName="grid" KeyFieldName="LineNo" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataMemoColumn FieldName="ParentRemark" Name="ParentRemark" VisibleIndex="17">
                                    ...
                                    <dx:GridViewDataMemoColumn FieldName="DrawingNote" Name="DrawingNote" VisibleIndex="20">
                                        <PropertiesMemoEdit EncodeHtml="False" Height="100"></PropertiesMemoEdit>
                                    </dx:GridViewDataMemoColumn>
                                    <dx:GridViewDataMemoColumn FieldName="SiteOrderDescription" Name="SiteOrderDescription" VisibleIndex="21">
                                        <PropertiesMemoEdit EncodeHtml="False" Height="100"></PropertiesMemoEdit>
                                    </dx:GridViewDataMemoColumn>
