<%@ Page Title="Master Plan" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="SampleMasterPlan.aspx.cs" Inherits="WebApp.sampling.SampleMasterPlan" %>
                    ...
                    <div class="">
                        <div class="work-progres" style="box-shadow: 0px 0px 5px -2px rgba(0,0,0,0.75); background-color: white; padding: 10px;">
                            <header class="widget-header">
                                <h4 id="txtDesciptionHeader" style="padding-bottom: 12px; margin-bottom: 0px; margin-top: 0px; padding-top: 4px;" runat="server" class="widget-title"><a href="/ReportViewer.aspx?type=masterplan" target="_blank">Online Sample Master Plan</a> <a href="MasterPlan?showPIpc=true">- Show PI Status </a>
