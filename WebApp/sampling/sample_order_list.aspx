<%@ Page Title="Factory Special Order List" Language="C#" MasterPageFile="~/SkinMaterialPro.Master" AutoEventWireup="true" CodeBehind="sample_order_list.aspx.cs" Inherits="WebApp.requisition.sample_order_list" %>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="border-bottom title-part-padding bg-body">
                            <h4 id="txtDesciptionHeader" runat="server" class="card-title mb-0 text-dark">Factory Special Order List</h4>
                        </div>
                        <div class="card-body shadow-sm table-responsive ">
                            ...
                            <dx:ASPxGridView ID="gridFactoryOrder" CssClass="" runat="server" Width="100%" AutoGenerateColumns="True" OnHtmlDataCellPrepared="gridFactoryOrder_HtmlDataCellPrepared">
